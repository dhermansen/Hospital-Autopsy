...
namespace NobleMuffins.TurboSlicer.Guts
{
	public static class ThreadSafeSlice
	{
		...
		private static readonly CollectionPool<ArrayBuilder<int>,int> intBuilderPool = new CollectionPool<ArrayBuilder<int>,int> (32, (cap) => new ArrayBuilder<int> (cap));
		private static readonly CollectionPool<ArrayBuilder<SplitAction>,SplitAction> splitActionBuilderPool = new CollectionPool<ArrayBuilder<SplitAction>,SplitAction> (32, (cap) => new ArrayBuilder<SplitAction> (cap));
		...
		public static void Slice (JobState jobState)
		{
			...
			try {
				...
				var readOnlyMesh = jobSpec.Data;
				var submeshCount = readOnlyMesh.indices.Length;
				var planeInLocalSpace = jobSpec.PlaneInLocalSpace;
				...
				jobState.Yield = new JobYield (jobSpec, alfaMesh, bravoMesh);
