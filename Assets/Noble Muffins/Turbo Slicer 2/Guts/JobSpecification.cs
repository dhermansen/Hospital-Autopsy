...
namespace NobleMuffins.TurboSlicer.Guts
{
	...
	{
		public JobSpecification(GameObject subject, MeshSnapshot data, Vector4 planeInLocalSpace, bool channelTangents, bool channelNormals, bool channelUV2, int shatterStep, bool destroyOriginal) {
			Subject = subject;
			Data = data;
		...
		public MeshSnapshot Data { get; private set; }
