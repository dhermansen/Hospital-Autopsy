...
namespace CaronteFX
{
  ...
  public class CNSoftbodyEditor : CNBodyEditor
  {
    ...
    static readonly GUIContent sbResolutionCt_                   = new GUIContent( CRStringManager.GetString("SbResolution"),                   CRStringManager.GetString("SbResolutionTooltip"));
    static readonly GUIContent sbRelativeLengthStiffnessCt_      = new GUIContent( CRStringManager.GetString("SbRelativeLengthStiffness"),      CRStringManager.GetString("SbRelativeLengthStiffnessTooltip"));
    static readonly GUIContent sbRelativeVolumeStiffnessCt_      = new GUIContent( CRStringManager.GetString("SbRelativeVolumeStiffness"),      CRStringManager.GetString("SbRelativeVolumeStiffnessTooltip"));
    static readonly GUIContent sbPlasticityCt_                   = new GUIContent( CRStringManager.GetString("SbPlasticity"),                   CRStringManager.GetString("SbPlasticityTooltip"));
    static readonly GUIContent sbPlasticityThresholdCt_          = new GUIContent( CRStringManager.GetString("SbPlasticityThreshold"),          CRStringManager.GetString("SbPlasticityThresholdTooltip"));
    static readonly GUIContent sbPlasticityAcquiredCt_           = new GUIContent( CRStringManager.GetString("SbPlasticityAcquired"),           CRStringManager.GetString("SbPlasticityAcquiredTooltip"));
    static readonly GUIContent sbPlasticityCompressionLimitCt_   = new GUIContent( CRStringManager.GetString("SbPlasticityCompressionLimit"),   CRStringManager.GetString("SbPlasticityCompressionLimitTooltip"));
    static readonly GUIContent sbPlasticityExpansionLimitCt_     = new GUIContent( CRStringManager.GetString("SbPlasticityExpansionLimit"),     CRStringManager.GetString("SbPlasticityExpansionLimitTooltip"));
