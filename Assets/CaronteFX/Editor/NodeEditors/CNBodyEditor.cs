...
namespace CaronteFX
{
  ...
  {
    static readonly GUIContent bdObjectsFieldCt_                 = new GUIContent( CRStringManager.GetString("BdObjectsBodyField"),             CRStringManager.GetString("BdObjectsBodyFieldTooltip"));
    static readonly GUIContent bdCollideToggleCt_                = new GUIContent( CRStringManager.GetString("BdCollideToggle"),                CRStringManager.GetString("BdCollideToggleTooltip") );
    static readonly GUIContent bdSetMassByOptionCt_              = new GUIContent( CRStringManager.GetString("BdSetMassByOption"),              CRStringManager.GetString("BdSetMassByOptionTooltip") );
    static readonly GUIContent bdMassValueCt_                    = new GUIContent( CRStringManager.GetString("BdMass"),                         CRStringManager.GetString("BdMassTooltip") );
    static readonly GUIContent bdDensityValueCt_                 = new GUIContent( CRStringManager.GetString("BdDensity"),                      CRStringManager.GetString("BdDensityTooltip") );
    static readonly GUIContent bdRestitutionValueCt_             = new GUIContent( CRStringManager.GetString("BdRestitution"),                  CRStringManager.GetString("BdRestitutionTooltip") );
    static readonly GUIContent bdKineticFrictionValueCt_         = new GUIContent( CRStringManager.GetString("BdKineticFriction"),              CRStringManager.GetString("BdKineticFrictionTooltip") );
    static readonly GUIContent bdStaticFrictionValueCt_          = new GUIContent( CRStringManager.GetString("BdStaticFriction"),               CRStringManager.GetString("BdStaticFrictionTooltip"));
    static readonly GUIContent bdFromKineticCt_                  = new GUIContent( CRStringManager.GetString("BdFromKinetic") );
    static readonly GUIContent bdExternalDampingValueCt_         = new GUIContent( CRStringManager.GetString("BdExternalDamping"),              CRStringManager.GetString("BdExternalDampingTooltip"));
    static readonly GUIContent bdInitialLinearVelocityValueCt_   = new GUIContent( CRStringManager.GetString("BdInitialLinearVelocty"),         CRStringManager.GetString("BdInitialLinearVeloctyTooltip"));
    static readonly GUIContent bdInitialAngularVelocityValueCt_  = new GUIContent( CRStringManager.GetString("BdInitialLinearAngularVelocity"), CRStringManager.GetString("BdInitialLinearAngularVelocityTooltip"));
    static readonly GUIContent bdExplosionOpacityValueCt_        = new GUIContent( CRStringManager.GetString("BdExplosionOpacity"),             CRStringManager.GetString("BdExplosionOpacityTooltip"));
    static readonly GUIContent bdExplosionResponsivenessValueCt_ = new GUIContent( CRStringManager.GetString("BdExplosionResponsiveness"),      CRStringManager.GetString("BdExplosionResponsivenessTooltip") );

    protected static readonly GUIContent bdAutoCollideCt_               = new GUIContent(CRStringManager.GetString("BdAutocollide"), CRStringManager.GetString("BdAutocollideTooltip"));
    protected static readonly GUIContent bdDisableCollisionsAtJointsCt_ = new GUIContent(CRStringManager.GetString("BdDisableCollisionsAtJoints"), CRStringManager.GetString("BdDisableCollisionsAtJointsTooltip"));
    protected static readonly GUIContent bdInternalDampingCt_           = new GUIContent(CRStringManager.GetString("BdInternalDamping"), CRStringManager.GetString("BdInternalDampingTooltip"));
