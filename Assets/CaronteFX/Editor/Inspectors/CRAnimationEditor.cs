...
namespace CaronteFX
{
  ...
  public class CRAnimationEditor : Editor
  {
    ...
    void OnEnable()
    {
      ...
      playerPremiumVersion_ = CRVersionChecker.IsPremiumVersion();
    }
    ...
    public void DrawRebakeAnimation()
    {
      ...
      {
        CRRebakeAnimationWindow.ShowWindow(ac_);     
      }
    ...
    public void DrawAddDefaultParticleSystem()
    {
      ...
      {
        CRAddDefaultParticleSystemWindow.ShowWindow(ac_);     
      }
      EditorGUI.EndDisabledGroup();
    }
    ...
    public void DrawExportToFbx()
    {
      ...
      {
        CRFbxExporterWindow.ShowWindow(ac_);     
      }
      EditorGUI.EndDisabledGroup();
    }
    ...
    public void DrawRecordScreenshots()
    {
      ...
      {
        CRMakeScreenshotsWindow.ShowWindow(ac_);     
      }
